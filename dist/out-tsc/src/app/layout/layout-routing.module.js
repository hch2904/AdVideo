...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'register-device', loadChildren: '../register-device/register-device.module#RegisterDeviceModule' },
            { path: 'register-user', loadChildren: './dashboard/register-user/register-user.module#RegisterUserModule' }
        ]
    }
];
